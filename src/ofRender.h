...
public:
	ofRender();
	void sgCoretoOFmesh(sgC3DObject *obj, CubieMesh &mesh,int numCubie,int selectedObjectID,string station);
	...
	void colorBlackSidesFromAxes(CubieMesh &mesh, int xp, int yp, int zp, int gridSize, float playRoom,ofVec3f armRot);
